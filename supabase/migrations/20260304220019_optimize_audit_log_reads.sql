...
revoke all on function public.fetch_audit_logs_page(integer, integer, text) from public;
grant execute on function public.fetch_audit_logs_page(integer, integer, text) to authenticated;
...
revoke all on function public.fetch_audit_logs_total(text) from public;
grant execute on function public.fetch_audit_logs_total(text) to authenticated;
